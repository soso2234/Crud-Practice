...
<body>
	...
	<div class="admin_content_wrap">
	    <div class="admin_content_subject"><span>공지사항 관리</span></div>
	    <div class="author_table_wrap">
          	<table class="author_table">
          		...
          		<tr>
          			<td><c:out value="${list.notice_seq}"></c:out> </td>
          			<td>
          				<a class="move" href='<c:out value="${list.notice_seq}"/>'>
        ...
        <div class="search_wrap">
        	<form id="searchForm" action="/admin/notice" method="get">
...
$(document).ready(function(){
    ...
    let result = '<c:out value="${noticeAdd_result} "/>';
    ...
    function checkResult(result){
        ...
        //alert("공지사항 '${noticeAdd_result}' 을 등록하였습니다.");
...
$(".move").on("click", function(e){
	...
	moveForm.attr("action", "/admin/noticeDetail");
	moveForm.submit();
