...
<body>
	<div class="wrapper">
		<div class="wrap">
			...
			<div class="content_area">
						...
						<tbody id="searchList>">
							<thead>
		            			<tr>
		            				...
		            				<c:if test = "${member != null}">
			            				<td>
			            					<button><a href="/freeboardAdd">등록</a></button>
			            				</td>
		            				</c:if>
		            			</tr>
		            		</thead>
							<c:forEach items="${list}" var="list">
								<tr>
									<td class="detail">
										<div class="noticeSeq">
											<c:out value="${list.freeboard_seq}"></c:out>
										</div>
									</td>
									<td class="detail">
										<a class="title" href='<c:out value="${list.freeboard_seq}"/>'>
				...
				<form id="moveForm" action="/freeboard" method="get" >
	...
	<script>
		...
		$(".title").on("click", function(e){
			...
			moveForm.attr("action", "/freeboardDetail");
			moveForm.submit();
